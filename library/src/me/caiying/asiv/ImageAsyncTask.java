...
public abstract class ImageAsyncTask<Void, Integer, Bitmap> {
    private static final String LOG_TAG = "IgAsyncTask";
    ...
    private static final ThreadFactory sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            return new Thread(r, "IgAsyncTask #" + mCount.getAndIncrement());
        }
    };
    ...
    private final WorkerRunnable<Void, Bitmap> mWorker;
    private final FutureTask<Bitmap> mFuture;
...
//                java.lang.Process.setThreadPriority(Process.THREAD_PRIORITY_BACKGROUND);
    ...
    protected final void publishProgress(Integer... values) {
        sHandler.obtainMessage(MESSAGE_POST_PROGRESS,
                new AsyncTaskResult<Integer>(this, values)).sendToTarget();
    }

    private void finish(Bitmap result) {
